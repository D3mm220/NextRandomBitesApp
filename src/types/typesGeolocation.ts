...
export class Convert {
  public static toPlaces(json: string): typesGeolocation {
    return cast(JSON.parse(json), r("Places"));
  }

  public static placesToJson(value: typesGeolocation): string {
...
const typeMap: any = {
  Places: o(
    [
      ...
      { json: "accuracy", js: "accuracy", typ: 3.14 },
    ],
    false,
  ),
  Location: o(
