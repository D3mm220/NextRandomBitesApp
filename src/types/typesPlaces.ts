...
export class Convert {
    public static toPlaces(json: string): typesPlaces {
        return cast(JSON.parse(json), r("Places"));
    }

    public static placesToJson(value: typesPlaces): string {
...
const typeMap: any = {
    ...
    "Result": o([
        { json: "business_status", js: "business_status", typ: r("BusinessStatus") },
        { json: "geometry", js: "geometry", typ: r("Geometry") },
        { json: "icon", js: "icon", typ: "" },
        { json: "icon_background_color", js: "icon_background_color", typ: r("IconBackgroundColor") },
        { json: "icon_mask_base_uri", js: "icon_mask_base_uri", typ: "" },
        { json: "name", js: "name", typ: "" },
        { json: "opening_hours", js: "opening_hours", typ: u(undefined, r("OpeningHours")) },
